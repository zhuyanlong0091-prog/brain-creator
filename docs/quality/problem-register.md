...
| C3 | Test credentials appeared in generated files | partial | PR D/PR E | Token/cookie values are removed from generated seeds; the shared Agent bridge boundary scans and redacts declared output paths; Run Ledger, Bug/Gap text, artifact manifests, Bridge/Host Agent logs, submissions, and Suite export redact or block known values plus high-confidence credential patterns; subprocess and full artifact lifecycle scan remains |
