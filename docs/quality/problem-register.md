...
| B4 | SPA remount invalidated the active Page | partial | PR E | Safe exploration now reacquires a closed/invalid active page before continuing, retries a stale safe target once, and isolates closed Popup evidence without dropping the main page; full cross-surface recovery remains |
