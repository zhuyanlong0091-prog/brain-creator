...
| D1 | Unread attachments were misclassified as model limitations | partial | PR A/PR B | PR A implements an attempted-first attachment pipeline; PR B must feed confirmed workflow/state models into requirement coverage |
